...
- **App update in progress:** settlement screen and dashboard consume backend balance source of truth; EAS iOS production build `ed5880a4-f3c4-4ba8-a80a-6e1f01126cdd` started for build number 17 and is queued/running, with cron watcher `ff751761b1ec` set to submit it when finished.
