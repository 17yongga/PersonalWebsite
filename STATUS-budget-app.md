...
- **App update submitted:** settlement screen and dashboard consume backend balance source of truth; EAS iOS production build `ed5880a4-f3c4-4ba8-a80a-6e1f01126cdd` finished for build number 17 and was submitted to App Store Connect/TestFlight. Submission: `541b3998-f65c-4abf-ad73-d1eee9b2c1ac`. Apple processing is pending/expected to take several minutes.
